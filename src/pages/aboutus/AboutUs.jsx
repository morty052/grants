...
const AboutUs = () => {
            ...
            <div className="grid gap-12">
              <div>
                ...
                <p className="mt-3 text-gray-800 ">
                  Platinum grants was put together by our founding team in
                  partnership with undp with one goal in mind. to provide relief
                  to people who need it the most hence why we have a very low
                  credit score qualification bar.
                </p>
              </div>
              ...
              <div className="space-y-6 lg:space-y-10">
                ...
                <div className="block space-y-2">
                  ...
                  <p className="-mt-2 text-gray-800 ">
                    Platinum Grants is always growing and constantly involving
                    to expand our reach keep checking back if you qualify for
                    any of our future grants.
                  </p>
                </div>
                {/* <!-- End Icon Block --> */}
              </div>
  ...
  return (
    <>
      <div className="py-4">
        <div className="container mx-auto sm:px-6 text-center md:px-12">
          <div className="mb-16">
            <h2 className="mb-4 text-center text-2xl font-bold text-gray-800  md:text-4xl">
              Platinum Grants leadership
            </h2>
            <p className="text-gray-600  lg:mx-auto lg:w-8/12 sm:text-2xl text-center">
              Our mission requires great people. <br /> meet the men and women
              behind Platinum grants.
            </p>
          </div>
          <div className="grid gap-28 py-20 md:grid-cols-3 md:gap-12">
            <div className="group space-y-8 border-t-4 border-gray-100 ">
              ...
              <div className="space-y-4 text-center">
                <div>
                  <h4 className="text-2xl text-gray-700 ">Hans Stegeman</h4>
            ...
            <div className="group space-y-8 border-t-4 border-gray-100 ">
              ...
              <div className="space-y-4 text-center">
                <div>
                  <h4 className="text-2xl text-gray-700 ">Mary Barra</h4>
                  <span className="block text-sm text-gray-500">
                    Chair at General Motors
                  </span>
                </div>
                {/* <a href="#" class="mx-auto block w-max text-primary">View Bio</a> */}
              </div>
            ...
            <div className="group space-y-8 border-t-4 border-gray-100 ">
              ...
              <div className="space-y-4 text-center">
                <div>
                  <h4 className="text-2xl text-gray-700 ">Dr Jason wingard</h4>
                  <span className="block text-sm text-gray-500">
                    Philadephia education job board
                  </span>
                </div>
                {/* <a href="#" class="mx-auto block w-max text-primary">View Bio</a> */}
              </div>
